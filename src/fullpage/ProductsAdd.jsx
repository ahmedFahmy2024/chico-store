...
export default function ProductsAdd() {
    ...
    const handleRecommendationChange = (selectedList) => {
        const selectedIds = selectedList.map(item => item.cat);
        setAddInput({ ...addInput, Recommendation_ID: selectedIds });
    };
    //  ================ add state ================
    ...
    async function handleDialogSubmit(e) {
        ...
        form.append("landing_switch", addInput.switch ? 1 : 0);
        ...
        addInput.Recommendation_ID.forEach(id => {
                                    ...
                                    <Editor
                                        ...
                                        init={{
                                            ...
                                            plugins: [
                                                ...
                                                'insertdatetime', 'media', 'table', 'code', 'help', 'wordcount','autoresize', 'paste'
                                            ],
